...
// -----------------------------------------------------
// swiftlint:disable line_length implicitly_unwrapped_optional conditional_returns_on_newline operator_usage_whitespace
import Foundation
import XCTest
...
internal enum SnapshotError: Error, CustomDebugStringConvertible {
